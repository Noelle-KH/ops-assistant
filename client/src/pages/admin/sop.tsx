            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center bg-white border rounded-lg p-1">
                {[
                  ...
                  { id: "exceptions", label: "3. 例外處理", icon: Zap },
                ].map((step) => (
                  <button
                    key={step.id}
              ...
              <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                ...
                <div className="space-y-4">
                  {currentSop.operation?.steps.map((step, i) => (
                    <div key={i} className="group relative p-6 rounded-2xl border border-slate-100 bg-slate-50/50 hover:bg-white hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 transition-all">
                      <div className="absolute -left-3 top-6 h-8 w-8 rounded-full bg-slate-900 text-white flex items-center justify-center font-black text-xs shadow-lg">
                        {i + 1}
                      </div>
                      <div className="space-y-4">
